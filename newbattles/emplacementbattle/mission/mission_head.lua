...
if IB_VERSION == 1 then
	if tonumber(date("%y%m%d")) >= 081010 and tonumber(date("%y%m%d")) <= 081020 then
		EXP_AWARD_WIN = 1200;	--胜利方经验奖励基数
		EXP_AWARD_LOSE = 1000;	--失败方经验奖励基数
		EXP_AWARD_DRAW = 1100;	--平局经验奖励基数
	else
		EXP_AWARD_WIN = 1200;	--胜利方经验奖励基数
		EXP_AWARD_LOSE = 1000;	--失败方经验奖励基数
		EXP_AWARD_DRAW = 1100;	--平局经验奖励基数
...
READY_TIMER_LOOP = (15*FRAME_PER_MIN/READY_TIME)-1;--报名准备时间计时器报时次数（15分钟）原来15
