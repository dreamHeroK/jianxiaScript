...
tTab =
{
	{"烈武装备箱（八卦）", 2, 95, 4000, 1, {1,100}, "装有烈武装备（八卦）的箱子，使用后可以获得一件与自身流派与体型相符的指定部位的烈武装备。"},
	{"烈武武器箱（八卦）", 2, 95, 4001, 2, {1,100}, "装有烈武武器（八卦）的箱子，使用后可以获得一件与自身流派与体型相符的烈武武器。"},
...
function UsePackToItem(nPlayerIndex, nItemIndex, style, room, dialog)
	...
	local tbID2 = {nil, {3,{22410,22411}}, {8,{22412,22413}}, {0,{22414,22415}}, nil, {1,{22416,22417,22418,22419}}, nil, {2,{nil,nil,22420,22421}}, {10,{nil,nil,22422,22423}}, nil, {0,{22424,22425,22426,22427}}, {5,{22428,22429,22430,22431}}, nil, {2,{22432,22433,22434,22435}}, {9,{22436,22437,22438,22439}}, nil, {6,{22440,22441,22442,22443}}, {4,{22444,22445,22446,22447}}, nil, {7,{22448,22449,22450,22451}}, {11,{22452,22453,22454,22455}}, nil, {2,{22456,22457}}, nil, {3,{22458,22459,22460,22461}}, {9,{22462,22463,22464,22465}}, {11,{22466,22467,22468,22469}}, nil, {13,{nil,nil,22470,22471}}, {12,{nil,nil,22472,22473}}, {14,{22474,22475,22476,22477}}, {2,{22478,22479}}};
