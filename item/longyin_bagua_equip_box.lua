...
tTab =
{
	{"龙隐装备箱（八卦）", 2, 95, 4012, 1, {1,100}, "装有龙隐装备（八卦）的箱子，使用后可以获得一件与自身流派与体型相符的指定部位的龙隐装备。"},
	{"龙隐武器箱（八卦）", 2, 95, 4013, 2, {1,100}, "装有龙隐武器（八卦）的箱子，使用后可以获得一件与自身流派与体型相符的龙隐武器。"},
...
function UsePackToItem(nPlayerIndex, nItemIndex, style, room, dialog)
	...
	if nRouteFlag ~= 1 then
		Talk(1,"","侠士还没加入任何流派，不能用<color=yellow>龙隐装备箱<color>。");
		return
	end;

	local nID2,nID3,nID4 = 0,0,0;
	local tbID2 = {nil, {3,{40070,40071}}, {8,{40072,40073}}, {0,{40074,40075}}, nil, {1,{40076,40077,40078,40079}}, nil, {2,{nil,nil,40080,40081}}, {10,{nil,nil,40082,40083}}, nil, {0,{40084,40085,40086,40087}}, {5,{40088,40089,40090,40091}}, nil, {2,{40092,40093,40094,40095}}, {9,{40096,40097,40098,40099}}, nil, {6,{40100,40101,40102,40103}}, {4,{40104,40105,40106,40107}}, nil, {7,{40108,40109,40110,40111}}, {11,{40112,40113,40114,40115}}, nil, {2,{40116,40117}}, nil, {3,{40118,40119,40120,40121}}, {9,{40122,40123,40124,40125}}, {11,{40126,40127,40128,40129}}, nil, {13,{nil,nil,40130,40131}}, {12,{nil,nil,40132,40133}}, {14,{40134,40135,40136,40137}}, {2,{40138,40139}}};
...
function open_pack_item(nPlayerIndex, nItemIndex, room, nID2, nID3)
	...
	if DelItemByIndex(nItemIndex,1) == 1 then
	 ...
	 -- AddItem(0,nID2,nID3,1,4,-1,-1,-1,-1,-1,-1,0,15,nLingqi)
		AddItem(0,nID2,nID3,1,4,0,0,0,0,0,0,0,0,150);
