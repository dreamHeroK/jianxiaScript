...
function OnUse(idx)
	...
	local UseBaiju = {
		"使用一个"..tTab[nTabIndex][4].."可以获得8小时"..tTab[nTabIndex][4].."时间。离线托管状态下，您将可以获得经验。",
		"您现在还剩余".. GetTask(val) .."分钟"..tTab[nTabIndex][4].."时间，您确实要使用"..tTab[nTabIndex][4].."吗？",
...
function use_bj_cb(nCount)
	...
	if DelItem(tTab[nTabIndex][1], tTab[nTabIndex][2], tTab[nTabIndex][3], nCount) == 1 then
		...
		Say("你的"..tTab[nTabIndex][4].."时间为<color=yellow>"..value.."<color>分钟！", 0)
		--cdkey
		if 1 == nTabIndex then
