...
g_szItemName = "<color=green>新服超值礼包<color>："
g_szPacketName = "新服超值礼包";	--包的名字 2,95,2057
g_tbItem = {
	[1] = { -- 新服超值礼包
		[1] = {
			nlevelname = "新服超值礼包", 
...
function OnUse(nItemIndex)
	...
	local szTitle = format("%s这是武林盟特制礼包，打开可获得：<color=red>请注意你得背包空间<color>\n<color=green>%s<color>", g_szItemName, szAwardStr)
