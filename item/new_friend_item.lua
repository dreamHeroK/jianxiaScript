...
g_szItemName = "<color=green>好友归来礼包<color>："
g_szPacketName = "好友归来礼包";	--包的名字 2,95,2057
g_tbItem = {
	[1] = { -- 好友归来礼包
		[1] = {
			nlevelname = "好友归来礼包", 
			room = {4, 400}, 
			item = {
				{gdp={2,95,52,300,1,4}, name = "藏宝箱钥匙"},
				{gdp={2,94,11,5,1,4}, name = "盛世银宝箱"},
				{gdp={2,94,10,50,1,4}, name = "盛世铜宝箱"},
			}, 
		},
	},
}
...
function OnUse(nItemIndex)
	...
	local szTitle = format("%s这是武林盟定制的新朋友礼包，打开可获得：<color=red>请注意你得背包空间<color>\n<color=green>%s, [师门高级秘籍]×1, [500万经验]<color>", g_szItemName, szAwardStr)
