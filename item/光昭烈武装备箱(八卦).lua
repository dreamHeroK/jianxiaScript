...
function OnUse()
	Say("<color=green>光昭烈武装备箱:<color>请选择您要获得的部位", 
		5,
		"头 部/getGuangZhaoLieWu",
		"衣 服/getGuangZhaoLieWu1",
		"下 装/getGuangZhaoLieWu2",
		"武 器/getGuangZhaoLieWu3",
		"考虑一下/no"
        )
end
function OnUsa(a)
...
function getGuangZhaoLieWu1(nLevel)
	if GetPlayerRoute() == 0 then
		Say("请先加入门派再进行相关操作！！", 0)
...
function getGuangZhaoLieWu2(nLevel)
	if GetPlayerRoute() == 0 then
		Say("请先加入门派再进行相关操作！！", 0)
...
function getGuangZhaoLieWu3(nLevel)
	if GetPlayerRoute() == 0 then
		Say("请先加入门派再进行相关操作！！", 0)
	...
	--AddItem(0,103,22340+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,-1,-1,-1,-1,-1,-1,-1,nLevel)    --帽子
	--AddItem(0,100,22340+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,-1,-1,-1,-1,-1,-1,-1,nLevel)    --衣服
	--AddItem(0,101,22480+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel)     --裤子
