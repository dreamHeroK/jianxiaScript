...
function OnUse()
	...
	Say("服用一个大人参果可获得秘籍修炼速度4倍时间4小时，您当前还剩余"..nHour.."小时"..nMin.."分钟大人参果修炼时间，确定要服用吗？",
		2,
		"是的/yes_use",
		"取消/no_use"
		)
...
function yes_use()
	...
	AskClientForNumber("use_cb", 1, tonumber(nHave), "服用大人参果数量")
end
...
function use_cb(nCount)
	...
	if DelItem(2, 0, 553, nCount) == 1 then
		...
		Msg2Player("你使用了大人参果。用4倍速度修练秘籍的时间为"..nHour.."小时"..nMin.."分钟")
	end
end
