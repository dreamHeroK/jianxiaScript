...
function OnUse()
	Say("<color=green>东皇凤鸣装备箱:<color>请选择您要获得的部位", 
		6,
		"头部/getcangwulongyinBaGua",
		"衣服/getcangwulongyinBaGua1",
		"下装/getcangwulongyinBaGua2",
		"首饰/getcangwulongyinBaGua3",
		"武器/getcangwulongyinBaGua4",
		"考虑一下/no"
        )
end
function OnUsa(a)
...
function getcangwulongyinBaGua3(nLevel)
	...
	route_offset[30] = {61-2,12,19}	--翠烟灵女 第一个数为-GetBody()的帽子衣服裤子武器偏移（女性门派GetBody()多2所以需要先扣2）；第二个数为武器类型；第三个数为戒指偏移
	DelItem(2,95,60028,1)
	AddItem(0,102,22943+route_offset[GetPlayerRoute()][3]*2+0,1,1,-1,-1,-1,-1,-1,-1,nLevel)    --戒指1
	AddItem(0,102,22943+route_offset[GetPlayerRoute()][3]*2+1,1,1,-1,-1,-1,-1,-1,-1,nLevel)    --戒指2
	--AddItem(0,103,40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,120)    --帽子
	--AddItem(0,100,40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,120)    --衣服
	--AddItem(0,101,22824+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,-1,-1,-1,-1,-1,-1,-1,nLevel)     --裤子
	--AddItem(0,route_offset[GetPlayerRoute()][2],40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,120)    --武器
...
function getcangwulongyinBaGua4(nLevel)
        if GetPlayerRoute() == 0 then
		Say("请先加入门派再进行相关操作！！", 0)
		return 0
	end
	...
	route_offset[30] = {61-2,12,19}	--翠烟灵女 第一个数为-GetBody()的帽子衣服裤子武器偏移（女性门派GetBody()多2所以需要先扣2）；第二个数为武器类型；第三个数为戒指偏移
	DelItem(2,95,60028,1)
	--AddItem(0,102,40045+route_offset[GetPlayerRoute()][3]*2+0,1,1,-1,-1,-1,-1,-1,-1,nLevel)    --戒指1
	--AddItem(0,102,40045+route_offset[GetPlayerRoute()][3]*2+1,1,1,-1,-1,-1,-1,-1,-1,nLevel)    --戒指2
	--AddItem(0,103,40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,120)    --帽子
	--AddItem(0,100,40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,120)    --衣服
	--AddItem(0,101,22824+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,-1,-1,-1,-1,-1,-1,-1,nLevel)     --裤子
	AddItem(0,route_offset[GetPlayerRoute()][2],23180+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,-1,-1,-1,-1,-1,-1,-1,nLevel)    --武器
