...
g_szItemName = "<color=green>新朋友礼包<color>："
g_szPacketName = "新朋友礼包";	--包的名字 2,95,5521
g_tbItem = {
	[1] = { -- 新朋友礼包
		[1] = {
			nlevelname = "新朋友礼包", 
			room = {4, 400}, 
			item = {
				{gdp={2,95,52,100,1,4}, name = "藏宝箱钥匙"},
				{gdp={2,94,11,1,1,4}, name = "盛世银宝箱"},
				{gdp={2,94,10,20,1,4}, name = "盛世铜宝箱"},
			}, 
		},
	},
}
