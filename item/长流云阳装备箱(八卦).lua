...
function OnUse()
	Say("<color=green>长流云阳装备箱【八卦】:<color>请选择您要获得的部位", 
		5,
...
function getcangwulongyinBaGua(nLevel)
	...
	AddItem(0,103,40522+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)     --帽子
	...
	--AddItem(0,route_offset[GetPlayerRoute()][2],40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)    --武器
...
function getcangwulongyinBaGua1(nLevel)
	...
	--AddItem(0,102,40045+route_offset[GetPlayerRoute()][3]*2+0,1,1,-1,-1,-1,-1,-1,-1)    --戒指1
	--AddItem(0,102,40045+route_offset[GetPlayerRoute()][3]*2+1,1,1,-1,-1,-1,-1,-1,-1)    --戒指2
	--AddItem(0,103,40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)    --帽子
	AddItem(0,100,40522+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)     --衣服
	--AddItem(0,101,40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)    --裤子
	--AddItem(0,route_offset[GetPlayerRoute()][2],40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)    --武器
...
function getcangwulongyinBaGua2(nLevel)
	...
	--AddItem(0,102,40045+route_offset[GetPlayerRoute()][3]*2+1,1,1,-1,-1,-1,-1,-1,-1)    --戒指2
	--AddItem(0,103,40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)    --帽子
	--AddItem(0,100,40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)    --衣服
	AddItem(0,101,40522+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)     --裤子
	--AddItem(0,route_offset[GetPlayerRoute()][2],40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)    --武器
...
function getcangwulongyinBaGua3(nLevel)
	...
	--AddItem(0,100,40210+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)    --衣服
	--AddItem(0,101,40522+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)     --裤子
	AddItem(0,route_offset[GetPlayerRoute()][2],40490+route_offset[GetPlayerRoute()][1]+GetBody(),1,1,0,0,0,0,0,0,0,nLevel,999)    --武器
