...
--目的地，目的地描述，消耗耐久，到目的地后地战斗状态
{
	[1] = 	--练级地图
	{
		...
		[9] = {35,"慕雪山庄",3,1},
		[10] = {36,"乌蒙部",3,1},
		[11] = {37,"云梦泽--31-40级",3,1},
		[12] = {38,"灵宝山--21-30级",3,1},
		[13] = {39,"江津村--21-30级",4,1},
		[14] = {40,"武陵山",3,1},
		[15] = {41,"武陵山脚",3,1},
		[16] = {42,"清溪洞",3,1},
		[17] = {43,"少林密室一层--31-40级",3,1},
		[18] = {44,"少林密室二层--31-40级",3,1},
		[19] = {45,"祥云洞--31-40级",3,1},
		[20] = {46,"阳中洞一层--31-40级",3,1},
		[21] = {47,"阳中洞二层--31-40级",4,1},
		[22] = {48,"阳中洞三层--31-40级",5,1},
		[23] = {49,"冰心洞一层--31-40级",4,1},
		[24] = {50,"冰心洞二层--41-50级",5,1},
		[25] = {51,"竹丝洞一层--31-40级",3,1},
		[26] = {52,"竹丝洞二层--31-40级",4,1},
		[27] = {53,"七星洞一层--21-30级",3,1},
		[28] = {54,"七星洞二层--41-50级",4,1},
		[29] = {55,"雁门关--41-50级",3,1},
		[30] = {56,"剑阁蜀道--31-40级",3,1},
		[31] = {57,"点苍山",3,1},
		[32] = {58,"武夷山--41-50级",3,1},
		[33] = {59,"伏牛山--41-50级",3,1},
		[34] = {60,"梁山泊--41-50级",3,1},
		[35] = {61,"两水洞一层--41-50级",4,1},
		[36] = {62,"两水洞二层--41-50级",5,1},
		[37] = {63,"金光洞--31-40级",3,1},
		[38] = {64,"青城山--41-50级",3,1},
		[39] = {65,"封魔洞一层--41-50级",4,1},
		[40] = {66,"封魔洞二层41-50级",5,1},
		[41] = {67,"燕子洞一层",3,1},
		[42] = {68,"燕子洞二层",4,1},
		[43] = {69,"黑风洞--51-60级",3,1},
		[44] = {70,"龙虎洞一层--51-60级",3,1},
		[45] = {71,"龙虎洞二层--51-60级",4,1},
		[46] = {72,"凤眼洞",3,1},
		[47] = {73,"白水洞一层",3,1},
		[48] = {74,"白水洞二层",4,1},
		[49] = {75,"东海海滨一--51-60级",3,1},
		[50] = {76,"东海海滨二--61-70级",4,1},
		[51] = {77,"龙眼洞一层",6,1},
		[52] = {78,"龙眼洞二层",7,1},
		[53] = {79,"天师洞一层--41-50级",5,1},
		[54] = {80,"天师洞二层--61-70级",6,1},
		[55] = {81,"丰都--61-70级",6,1},
		[56] = {82,"大草原一--61-70级",3,1},
		[57] = {83,"大草原二--61-70级",4,1},
		[58] = {84,"王旗部落--61-70级",4,1},
		[59] = {85,"桃花岛--61-70级",5,1},
		[60] = {86,"鬼门回廊",7,1},
		[61] = {87,"清音洞一层",5,1},
		[62] = {88,"清音洞二层",6,1},
		[63] = {89,"西双版纳北部",5,1},
		...
		[66] = {92,"千寻塔二层",7,1},
		[67] = {93,"千寻塔三层",8,1},
		[68] = {94,"王母洞一层--81-90级",6,1},
		[69] = {95,"王母洞二层--90级以上",7,1},
		[70] = {96,"王母洞三层--90级以上",8,1},
		[71] = {98,"天师秘境",8,1},
		[72] = {99,"凤翔府北",4,1},
		[73] = {100,"凤翔府南",4,1},
		[74] = {101,"龙门镇",5,1},
...
--		[91] = {121,"泉州府北",4,1},
--		[92] = {122,"泉州府西",4,1},
		[85] = {"NewWorld(205,1580,2879)","汴京府东",3,1},
		[86] = {"NewWorld(203,1568,3152)","汴京府西",3,1},
		[87] = {"NewWorld(201,1588,2805)","汴京府南",3,1},
		[88] = {"NewWorld(301,1586,3187)","成都府西",3,1},
		[89] = {"NewWorld(304,1568,2826)","成都府南",3,1},
		[90] = {"NewWorld(308,1401,3228)","成都府北",3,1},
		[91] = {"NewWorld(108,1402,3204)","泉州府北",3,1},
		[92] = {"NewWorld(105,1590,3188)","泉州府西",3,1},	
	...
	[2] = 	--门派地图
	{
		...
		[10] = {"NewWorld(152,1690,3289)","明教",5,0,1},
	},
	[3] = 	--功能NPC处
	{
		[0] = "城市NPC处",
		[1] = 
		{
			...
			[5] = {"NewWorld(200,1169,2845)","兔小丫",5,0},
			[6] = {"NewWorld(200,1360,2925)","商会老板",5,0},
			[7] = {"NewWorld(200,1414,2936)","行脚商人",5,0},
			...
			[14] = {"NewWorld(200,1392,2817)","比武大会特使",5,0},
		},
		[2] = 
		{
			[0] = "成都",
			...
			[5] = {"NewWorld(300,1653,3559)","兔小丫",5,0},
			[6] = {"NewWorld(300,1897,3492)","商会老板",5,0},
			[7] = {"NewWorld(300,1732,3548)","行脚商人",5,0},
			...
			[15] = {"NewWorld(300,1840,3570)","擂台老板",5,0},
		...
		[3] = 
		{
			...
			[5] = {"NewWorld(100,1459,2811)","兔小丫",5,0},
			[6] = {"NewWorld(100,1537,2933)","商会老板",5,0},
			[7] = {"NewWorld(100,1499,3059)","行脚商人",5,0},
		...
		[4] = 
		{
			...
			[5] = {"NewWorld(150,1680,3118)","兔小丫",5,0},
			[6] = {"NewWorld(150,1635,3139)","商会老板",5,0},
			[7] = {"NewWorld(150,1653,3109)","行脚商人",5,0},
			[8] = {"NewWorld(150,1738,3158)","捕头",5,0},
			[9] = {"NewWorld(150,1744,3121)","藏剑使者",5,0},
			[10] = {"NewWorld(150,1713,3137)","周末活动大使",5,0},
			[11] = {"NewWorld(150,1680,3161)","兵马指挥使",5,0},
			[12] = {"NewWorld(150,1650,3174)","紫光阁神秘人",5,0},
			[13] = {"NewWorld(150,1600,3136)","媒婆",5,0},
			[14] = {"NewWorld(150,1588,3143)","巧女",5,0},
			[15] = {"NewWorld(150,1711,3046)","婚庆使者",5,0},
			[16] = {"NewWorld(150,1701,3170)","武林盟特使",5,0},
		},
		[5] = 
		{
			[0] = "襄阳",
		...
		[6] = 
		{
			...
			[4] = {"NewWorld(400,1485,3018)","兔小丫",5,0},
		...
		[7] = 
		{
			...
			[7] = {"NewWorld(500,1762,3127)","兔总管",5,0},
			[8] = {"NewWorld(500,1640,3183)","龙光真人",5,0},
		},		
		[8] = 
		{
			[0] = "玉融峰",
			[1] = {"NewWorld(426,1664,3101)","文史掌门",5,0},	
			[2] = {"NewWorld(426,1641,2968)","方音",5,0},	
			[3] = {"NewWorld(426,1631,3101)","药店老板(文史)",5,0},	
			[4] = {"NewWorld(426,1629,2950)","物品保管人(文史)",5,0},	
			[5] = {"NewWorld(426,1513,3095)","少阳掌门",5,0},	
			[6] = {"NewWorld(426,1480,3010)","范星澜",5,0},	
			[7] = {"NewWorld(426,1549,3110)","药店老板(少阳)",5,0},	
			[8] = {"NewWorld(426,1495,2992)","物品保管人(少阳)",5,0},	
			[9] = {"NewWorld(426,1608,3175)","车夫",5,0},	
		},				
		[9] = 
		{
			[0] = "武林盟",
			[1] = {"NewWorld(425,1740,3231)","物品管理员",5,0},	
			[2] = {"NewWorld(425,1676,3225)","天工巧手刘诗英",5,0},	
			[3] = {"NewWorld(425,1789,3181)","叶子丘",5,0},	
			[4] = {"NewWorld(425,1705,3174)","韩丹心",5,0},	
			[5] = {"NewWorld(425,1792,3185)","铁面",5,0},	
			[6] = {"NewWorld(425,1743,3410)","绝情",5,0},	
			[7] = {"NewWorld(425,1830,3209)","冰心",5,0},	
			[8] = {"NewWorld(425,1939,3442)","地煞",5,0},	
			[9] = {"NewWorld(425,1787,3151)","百晓生",5,0},	
			[10] = {"NewWorld(425,1790,3240)","诸葛棋",5,0},	
			[11] = {"NewWorld(425,1658,3217)","宝珠金刚",5,0},	
			[12] = {"NewWorld(425,1642,3229)","陈卓浩",5,0},	
			[13] = {"NewWorld(425,1645,3224)","杨三宝",5,0},	
			[14] = {"NewWorld(425,1740,3301)","仲开嵘",5,0},	
			[15] = {"NewWorld(425,1727,3266)","唐梦琳",5,0},	
			[16] = {"NewWorld(425,1721,3300)","秦无命",5,0},	
			[17] = {"NewWorld(425,1796,3230)","莫烟雨",5,0},	
			[18] = {"NewWorld(425,1750,3099)","萧楚楚",5,0},	
			[19] = {"NewWorld(425,1721,3124)","熊霸天",5,0},	
			[20] = {"NewWorld(425,1829,3211)","吴不维",5,0},	
		},		
	},
	[4] = 	--生活采集技能师傅处
	{
		[0] = "生活采集技能师傅处",
		[1] = {"NewWorld(300,1836,3430)","成都代矿工（挖矿）",3,0},
		[2] = {"NewWorld(300,1848,3493)","成都黄大婶（抽丝）",3,0},
		[3] = {"NewWorld(200,1220,2909)","汴京刘一斧（伐木）",3,0},
		[4] = {"NewWorld(200,1347,3029)","汴京张猎户（狩猎）",3,0},
		[5] = {"NewWorld(100,1393,2969)","泉州莫君道（集灵）",3,0},
		[6] = {"NewWorld(100,1555,2961)","泉州林药师（采药）",3,0},
		[7] = {"NewWorld(100,1603,2968)","泉州李丰收（桑耕）",3,0},
	},
	[5] = 	--生活生产技能师傅处
	{
		[0] = "生活生产技能师傅处",
		[1] = {"NewWorld(200,1429,3022)","汴京莫大（锻造）",3,0},
		[2] = {"NewWorld(200,1579,2889)","汴京御厨（烹饪）",3,0},
		[3] = {"NewWorld(200,1330,2731)","汴京鲁伯能（天工）",3,0},
		[4] = {"NewWorld(300,1730,3611)","成都游方医生（制药）",3,0},
		[5] = {"NewWorld(300,1866,3477)","成都锦娘（刺绣）",3,0},
		[6] = {"NewWorld(350,1544,2935)","襄阳明师傅（缝纫）",3,0},
	},
	[6] = 	--我想游戏功能地图
	{
		[0] = "游戏功能报名处",
		...
		[2] = 
			{
				[0] = "师门密室",
				[1] = {"NewWorld(204,1644,3270)","少林 玄空",5,0},
				[2] = {"NewWorld(305,1674,2936)","唐门 唐苏幕",5,0},
				[3] = {"NewWorld(303,1715,3059)","峨嵋 慧芸师太",5,0},
				[4] = {"NewWorld(209,1530,3209)","丐帮 彭虏望",5,0},
				[5] = {"NewWorld(312,1871,3276)","武当 薛云铮",5,0},
				[6] = {"NewWorld(219,1542,2939)","杨门 杨延昭",5,0},
				[7] = {"NewWorld(407,1572,3160)","五毒 勾册",5,0},
				[8] = {"NewWorld(509,1539,3230)","昆仑 陈不为",5,0},
				[9] = {"NewWorld(404,1539,2698)","翠烟 刘青眉",5,0},
				[10] = {"NewWorld(152,1350,2872)","明教 石宝",5,0},
		},
		[3] = 
			{
				[0] = "宋辽战场",
				[1] = {"NewWorld(200,1291,2873)","赵延年(雁门关宋报名处)",5,0},
				[2] = {"NewWorld(200,1301,2793)","萧远楼(雁门关辽报名处)",5,0},
		},
	},
}
...
function OnUse(nIdx)
	local szItemTitle = ""
	local szTitle = "您要使用神行宝典去向何方呢？根据目标地点的不同，宝典相应的耐久消耗也会有不同。"
	local nChkVip = chk_vip_card()
	if nChkVip == 1 then
		szItemTitle = "<color=green>贵宾虎纹卡<color>："
		szTitle = "您要使用神行宝典去向何方呢？"
	end
	...
	if nMapID == 606 or nMapID == 101 or nMapID == 117 or (nMapID >= 700 and caji_map_chk_flag == 0) then
		Talk(1,"","特殊地图不可使用神行宝典。");
		return 0;
	end;
	if GetPKFlag() ~= 0 and GetFightState() == 1 then
		Talk(1,"","野外PK状态下不可使用神行宝典。");
		return 0;
	end	
	if GetPKFlag() ~= 0 and GetFightState() == 1 then
		Talk(1,"","野外PK状态下不可使用神行宝典。");
	...
	if GetTaskTemp(111) == 1 then
		Talk(1,"","带有镖旗状态可使用神行宝典。")
		return 0
	end
	...
	if (nleft == 0) then
		Say("您的神行宝典的耐久度为0，将删除您的神行宝典。", 0)
		DelItemByIndex(nScrollIndex, 0)					-- 耐久为0要删除掉物品
	end
	local selTab = {};
	tinsert(selTab,"我最近去过的一些地方/#flight_recently("..nScrollIndex..")");
	for i=1,getn(TB_DES_INFO) do
		tinsert(selTab,"我要去"..format(TB_DES_INFO[i][0].."/#list_destination(%d,%d)",nScrollIndex,i));--我要去
	end;
	tinsert(selTab,"暂不使用/cancel_dialog");
	Say(szItemTitle..szTitle, getn(selTab), selTab);
end;
...
function list_destination(nScrollIndex,...)
	...
	if type(tbDes[1][1]) == "table" then	--还得深入一层
		...
		tinsert(selTab,"返回主对话框/#OnUse("..nScrollIndex..")")
		tinsert(selTab,"暂不使用/cancel_dialog");
		Say(szItemTitle..szTitle,getn(selTab),selTab);
	else
...
function list_page(nPageNum,nScrollIndex,...)
	...
	Say(szItemTitle.."请问你要到以下哪个地方呢？当前第<color=yellow>"..nPageNum.."<color>页，共<color=yellow>"..nMaxPage.."<color>页。",getn(selTab),selTab);
end;
...
function get_destination_list(nScrollIndex,...)
	...
	for i=1,getn(tbDes) do
		...
		if nChkVip >= 1 then
			...
			szAbradeTitle = " (消耗耐久"..tbDes[i][3].."点)"
		end
		szCmdStr = tbDes[i][2]..szAbradeTitle..get_cmd_string("go_to_destination",nScrollIndex,gf_UnPack(arg));
...
function flight_recently(nScrollIndex)
	...
	if GetTask(FLIGHTPOSTASKID_BEGIN) == 0 then
		Talk(1,"#OnUse("..nScrollIndex..")", szItemTitle.."你最近没有使用过神行宝典呀。");
		return 0;
	end;
	local selTab = {};
	local tbDes = {};
		...
		if getn(tbIndex) >= 2 then	--旧的神行getn(tbIndex) == 1
			...
			if tbDes ~= nil then	--如果是nil值就跳过
				if nChkVip >= 1 then
					...
					szAbradeTitle = " (消耗耐久"..tbDes[3].."点)"
				end
				szCmdStr = szPlaceHeader..tbDes[2]..szAbradeTitle..get_cmd_string("go_to_destination",nScrollIndex,gf_UnPack(tbIndex));
				tinsert(selTab,szCmdStr);
			end;
		end;
	end;
	tinsert(selTab,"返回主对话框/#OnUse("..nScrollIndex..")")
	tinsert(selTab,"暂不使用/cancel_dialog");
	Say(szItemTitle.."你最近去过的地方：",getn(selTab),selTab);
end;
...
function chk_vip_card()
	...
	if (nNowTime >= nExpireTime) then
		...
		if nExpireType == 1 then
			return 1;		-- 正常
		elseif nExpireType == 2 then
			return 2;		-- 正常
		elseif nExpireType == 3 then
			return 3;		-- 正常
		end
	end
end;
