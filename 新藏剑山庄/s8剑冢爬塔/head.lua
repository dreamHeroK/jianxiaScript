...
Include("\\script\\新藏剑山庄\\s8剑冢爬塔\\mission_award.lua")

thisFile = "\\script\\新藏剑山庄\\s8剑冢爬塔\\mission.lua";
...
--以下为missionV变量
	...
	szNpc_tongling = "素仙",--此处boss名称妖改
	szNpc_boss1 = "外院总管",--此处boss名称妖改	
	szNpc_boss2 = "内院总管",--此处boss名称妖改	
	szNpc_boss3 = "大小姐",--此处boss名称妖改	
	szNpc_boss4 = "总管",--此处boss名称妖改	
	szNpc_boss5 = "剑魂",--此处boss名称妖改	
	szNpc_boss6 = "疯一帆",--此处boss名称妖改	
	szNpc_boss7 = "林冲",--此处boss名称妖改	
	szNpc_boss8 = "牛头怪",--此处boss名称妖改	
	szNpc_boss9 = "花圣",--此处boss名称妖改	
	szNpc_boss10 = "素仙",--此处boss名称妖改		
...
tNpcs = {
	...
	boss1 = {"秦始皇亡魂","外院总管", thisFile, nil, CampEnemy, 0},
	boss2 = {"秦始皇亡魂","内院总管", thisFile, nil, CampEnemy, 0},
	boss3 = {"秦始皇亡魂","大小姐", thisFile, nil, CampEnemy, 0},
	boss4 = {"秦始皇亡魂","总管", thisFile, nil, CampEnemy, 0},
	boss5 = {"秦始皇亡魂","剑魂", thisFile, nil, CampEnemy, 0},
	boss6 = {"秦始皇亡魂","疯一帆", thisFile, nil, CampEnemy, 0},
	boss7 = {"秦始皇亡魂","林冲", thisFile, nil, CampEnemy, 0},
	boss8 = {"秦始皇亡魂","牛头怪", thisFile, nil, CampEnemy, 0},
	boss9 = {"秦始皇亡魂","花圣", thisFile, nil, CampEnemy, 0},
	boss10 = {"秦始皇亡魂","素仙", thisFile, nil, CampEnemy, 0},	
};
...
function ttd_createJTYL(nStage)
       --nStage1等于开始  
	local tJTYLPos = {{1567,3236},{1567,3236}};
