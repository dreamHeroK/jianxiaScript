...
Include("\\script\\新藏剑山庄\\s1山门\\mission_award.lua")

thisFile = "\\script\\新藏剑山庄\\s1山门\\mission.lua";
...
tNpcs = {
	...
	boss1 = {"藏剑山庄外院总管70","藏剑山庄外院总管", thisFile, nil, CampEnemy, 0},
};
...
function ttd_createJTYL(nStage)
       --nStage1等于开始  
	local tJTYLPos = {{1529,3476},{1597,3216}};
