...
Include("\\script\\新藏剑山庄\\s7剑冢\\mission_award.lua")

thisFile = "\\script\\新藏剑山庄\\s7剑冢\\mission.lua";
...
--以下为missionV变量
	...
	szNpc_tongling = "九绝剑魔",--此处boss名称妖改
}
...
tNpcs = {
	...
	boss1 = {"剑魂70","九绝剑魔", thisFile, nil, CampEnemy, 0},
};
...
gf_ModifyExp(6000000);--增加经验600W
gf_Modify("Money", 30 * 10000)
gf_AddItemEx({2,95,18414,1,4},"副本币");
