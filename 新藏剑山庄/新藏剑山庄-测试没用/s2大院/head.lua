...
Include("\\script\\新藏剑山庄\\s2大院\\mission_award.lua")

thisFile = "\\script\\新藏剑山庄\\s2大院\\mission.lua";
...
--以下为missionV变量
	...
	szNpc_tongling = "藏剑山庄内院总管",--此处boss名称妖改
	szNpc_tongling2 = "内院总管",--此处boss名称妖改	
...
tNpcs = {
	...
	boss1 = {"山庄内院总管70","藏剑山庄内院总管", thisFile, nil, CampEnemy, 0},
	boss2 = {"内院总管对话","内院总管", "\\script\\新藏剑山庄\\s2大院\\neiyuanzongguan.lua", nil, CampEnemy, 0},	
...
function ttd_createJTYL(nStage)
       --nStage1等于开始  
	local tJTYLPos = {{1613,3182},{1659,3128}};
