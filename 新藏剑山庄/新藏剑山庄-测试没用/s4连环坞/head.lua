...
Include("\\script\\新藏剑山庄\\s4连环坞\\runtime_data_stat.lua")
Include("\\script\\新藏剑山庄\\s4连环坞\\mission_award.lua")

thisFile = "\\script\\新藏剑山庄\\s4连环坞\\mission.lua";
...
tNpcs = {
	...
	boss1 = {"大庄主70","藏剑山庄大庄主", thisFile, nil, CampEnemy, 0},
	lz1 = {"透明人打不动","土清香炉", thisFile, nil, CampEnemy, 0},	
	lz2 = {"透明人打不动","土清香炉", thisFile, nil, CampEnemy, 0},	
	lz3 = {"透明人打不动","土清香炉", thisFile, nil, CampEnemy, 0},	
	lz4 = {"透明人打不动","红林香炉", thisFile, nil, CampEnemy, 0},	
	lz5 = {"透明人打不动","红林香炉", thisFile, nil, CampEnemy, 0},	
	lz6 = {"透明人打不动","红林香炉", thisFile, nil, CampEnemy, 0},		
	lz7 = {"透明人打不动","紫林香炉", thisFile, nil, CampEnemy, 0},	
	lz8 = {"透明人打不动","紫林香炉", thisFile, nil, CampEnemy, 0},	
	lz9 = {"透明人打不动","紫林香炉", thisFile, nil, CampEnemy, 0},		
};
...
function ttd_createJTYL(nStage)
       --nStage1等于开始  
	local tJTYLPos = {{1697,3067},{1860,2899}};
...
ttd_confirmClose()
SendScript2VM("\\script\\新藏剑山庄\\s5藏剑阁\\jt_npc.lua", "entry_jingli()");
end
end
