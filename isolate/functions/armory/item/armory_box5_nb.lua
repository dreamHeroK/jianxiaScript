...
g_tMagicAttribute.tMagicInfo = {
		[1] = { -- 头 衣服 裤子 首饰
		{10, 10, 10, 10, {"力量增加,根骨增加,提高五行攻击属性",  {819, 2}, {855, 2}, {1174, 2},{1762, 1},{2560, 3}}},
		{10, 10, 10, 10, {"力量增加,洞察增加,提高五行攻击属性",  {820, 2}, {856, 2}, {1175, 2},{1763, 1},{2561, 3}}},
		{20, 20, 20, 20, {"力量增加,身法增加,提高五行攻击属性",  {821, 2}, {857, 2}, {1176, 2},{1764, 1},{2562, 3}}},
		{15, 15, 15, 15, {"内功增加,洞察增加,提高五行攻击属性",  {822, 2}, {858, 2}, {1177, 2},{1765, 1},{2563, 3}}},
		{10, 10, 10, 10, {"内功增加,身法增加,提高五行攻击属性",  {823, 2}, {859, 2}, {1178, 2},{1766, 1},{2564, 3}}},
		{10, 10, 10, 10, {"内功增加,根骨增加,提高五行攻击属性",  {824, 2}, {860, 2}, {1179, 2},{1767, 1},{2565, 3}}},
		{15, 15, 15, 15, {"洞察增加,身法增加,提高五行攻击属性",  {825, 2}, {861, 2}, {1180, 2},{1768, 1},{2566, 3}}},
		{5, 5, 5, 5,     {"洞察增加,根骨增加,提高五行攻击属性",  {826, 2}, {862, 2}, {1181, 2},{1769, 1},{2567, 3}}},
		{5, 5, 5, 5,     {"身法增加,根骨增加,提高五行攻击属性",  {827, 2}, {863, 2}, {1182, 2},{1770, 1},{2568, 3}}},
	},
	[2] = {
		{5, 5, 5, 5, {"所有攻击附带五行金属性,天命点数增加",  {779, 2}, {779, 2}, {1183, 2},{1771, 1},{2569, 3}}},
		{5, 5, 5, 5, {"所有攻击附带五行木属性,天命点数增加",  {780, 2}, {780, 2}, {1184, 2},{1772, 1},{2570, 3}}},
		{5, 5, 5, 5, {"所有攻击附带五行水属性,天命点数增加",  {781, 2}, {781, 2}, {1185, 2},{1773, 1},{2571, 3}}},
		{5, 5, 5, 5, {"所有攻击附带五行火属性,天命点数增加",  {782, 2}, {782, 2}, {1186, 2},{1774, 1},{2572, 3}}},
		{5, 5, 5, 5, {"所有攻击附带五行土属性,天命点数增加",  {783, 2}, {783, 2}, {1187, 2},{1775, 1},{2573, 3}}},
		{5, 5, 5, 5, {"增加金抗性,天命点数增加",              {784, 2}, {784, 2}, {1188, 2},{1776, 1},{2574, 3}}},
		{5, 5, 5, 5, {"增加木抗性,天命点数增加",              {785, 2}, {785, 2}, {1189, 2},{1777, 1},{2575, 3}}},
		{5, 5, 5, 5, {"增加水抗性,天命点数增加",              {786, 2}, {786, 2}, {1190, 2},{1778, 1},{2576, 3}}},
		{5, 5, 5, 5, {"增加火抗性,天命点数增加",              {787, 2}, {787, 2}, {1191, 2},{1779, 1},{2577, 3}}},
		{5, 5, 5, 5, {"增加土抗性,天命点数增加",              {788, 2}, {788, 2}, {1192, 2},{1780, 1},{2578, 3}}},
		{10, 10, 10, 10, {"伤害增加,天命点数增加",            {790, 2}, {790, 2}, {1194, 2},{1782, 1},{2579, 3}}},
		{10, 10, 10, 10, {"内攻提高,天命点数增加",            {790, 2}, {790, 2}, {1195, 2},{1783, 1},{2580, 3}}},
		{5, 5, 5, 5, {"内攻提高,天命点数增加",            {795, 2}, {795, 2}, {1198, 2},{1786, 1},{2581, 3}}},
	},
	[3] = {
		[1] = {1, 1, 1, 1, {"生命上限提高,内力上限提高,增加五行全抗性",  {799, 2}, {800, 2}, {1199, 2},{1787, 1},{2582, 3}}},
	},
};

g_tRouteArmory = {
	{1, {"师门专用5级头部纹饰", 0, 116, 5000, "纹饰-头"}},
	{1, {"师门专用5级上衣纹饰", 0, 113, 5000, "纹饰-衣"}},
	{1, {"师门专用5级下装纹饰", 0, 114, 5000, "纹饰-装"}},
	{1, {"师门专用5级首饰纹饰", 0, 115, 5000, "纹饰-首饰"}},
	{1, {"师门专用5级首饰纹饰", 0, 117, 5001, "纹饰-首饰2"}},
}
