...
--	get_server_id()
	...
	if nTalkValue9 == 0 and  GetLevel() < 10 then
		...
		gf_AddItemEx({2,95,40104,1,4},"称号楚楚动人");
		gf_AddItemEx({2,95,60031,1,4},"瀚宇武器包");
		gf_AddItemEx({2,95,60032,3,4},"瀚宇装备包");
		gf_AddItemEx({2,95,60016,1,4},"师恩难忘包");
...
RemoveTitle(52, 1)
 if GetItemCount(2, 103, 18889) < 1 then
  AddItem(2, 103, 18889, 1) --新手指引
 end 
 if GetItemCount(2, 95, 572) < 1 then
  AddItem(2, 95, 572, 1) --欠遍合
 end  
