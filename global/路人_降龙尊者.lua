...
strTitle = "<color=green>剑侠使者<color>："

FILE_NAME 	= "\\script\\global\\路人_降龙尊者.lua"
...
--	tinsert(selTab, format("◆666与999灵气装备/#show_equip_shop(4018)"));
--	tinsert(selTab, format("◆炎帝装备兑换/#show_equip_shop(3001)"));
--	tinsert(selTab, format("◆轩辕首饰武器/#show_equip_shop(3003)"));
--	tinsert(selTab, format("◆师门六套装备/#show_equip_shop(3100)"));
--	tinsert(selTab, format("◆皓月装备兑换/#show_equip_shop(3101)"));
--	tinsert(selTab, format("◆耀阳装备兑换/#show_equip_shop(3102)"));
	tinsert(selTab, format("\n◆凤鸣装备兑换/#show_equip_shop(3106)"));
	tinsert(selTab, format("\n◆东皇凤鸣兑换/#show_equip_shop(3107)"));
	tinsert(selTab, format("\n◆龙隐装备兑换/#show_equip_shop(3110)"));
	tinsert(selTab, format("\n◆苍梧龙隐兑换/#show_equip_shop(3111)"));
	tinsert(selTab, format("\n◆极品首饰/#show_equip_shop(3112)"));
	tinsert(selTab, format("\n◆外装蕴灵兑换/#show_equip_shop(3002)"));
--	tinsert(selTab, format("◆装备回收/_equip_recycle"));
...
function days_lease_xiashi()
	local selTab = {};
	local szTitle = format("%s可以使用2000金来兑换侠士装备体验箱，开启侠士装备体验箱可获得限时30天并可指定属性的限时侠士套装。您确定要兑换吗？<color=red>每个角色仅只可兑换1次<color>。\n    限时侠士装备为绑定，不可交易、回收、修理，耐久1000，时间结束后自动消失。\n    侠士装备套装需要等级10级且加入流派。", strTitle)
...
function do_days_lease_xiashi()
	...
	if GetLevel() < 10 then
		Talk(1,"", format("%s侠士还没达到10级，不能兑换侠士装备体验箱。", strTitle));
		return
	end;
	...
	gf_AddItemEx2({2,95,1439,1,4}, "侠士装备体验箱", "兑换侠士装备体验箱", "获得侠士装备体验箱", 0, 1);
