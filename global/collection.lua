...
function ShowHelp_Horse()
	local szTitle	= "";
	szTitle = szTitle.."    ◆ 坐骑被收藏后，物品将<color=yellow>消失<color>并记录到“小小马厩”中，可无限次取出。\n";
	szTitle = szTitle.."    ◆ 坐骑被收藏后，再次取出即为绑定物品，<color=yellow>不可交易<color>。\n";
...
function ShowHelp_Ornament()
	local szTitle	= "";
	szTitle = szTitle.."    ◆ 挂件被收藏后，物品将<color=yellow>消失<color>并记录到“小小玉椟”中，可无限次取出。\n";
	szTitle = szTitle.."    ◆ 挂件被收藏后，再次取出即为绑定物品，<color=yellow>不可交易<color>。\n";
	szTitle = szTitle.."    ◆ 有时限的挂件不能常伴身侧，故不能被收藏。"
	szTitle = szTitle.."\n";
	Say(szTitle, 1, {"我知道了 /nothing"});
end
