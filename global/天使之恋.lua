...
strTitle = "<color=green>天使之恋<color>："

FILE_NAME 	= "\\script\\global\\天使之恋.lua"
...
local szTitle = format("%s<color=red2>欢迎您来到《天使剑侠情缘2》，天使之恋温馨提示：<color><color=red>各种碎片→天罡令→混沌紫玉碎片→混沌紫玉、混沌金玉，混沌绿玉。!!<color><color=pink>可换终级极品装备，！下面可以查看各种装备所需！！", strTitle)
	...
	tinsert(selTab, format("◆四灵神秘装备 兑换/#show_equip_shop(3103)"));
	tinsert(selTab, format("◆传说隐龙武器 兑换/#show_equip_shop(3108)"));
	tinsert(selTab, format("◆极品称号兑换/#show_equip_shop(3109)"));
