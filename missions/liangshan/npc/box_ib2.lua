...
--}
--tClause2 = {
--	{{"小包的陨铁精石"    	,{2,1,3356,1},msg},    10.00*100},
--	{{"打包的陨铁"         	,{2,1,1050,1}},        5.00*100},
--	{{"7级灵石包"          	,{2,1,30305,1},msg}, 	10.00*100},
--	{{TTGLInfo[4]          	,{TTGLInfo[1],TTGLInfo[2],TTGLInfo[3],1},msg},    1.00*100 },
--	{{TTGLInfo[4]          	,{TTGLInfo[1],TTGLInfo[2],TTGLInfo[3],1},msg},    0.50*100 },
--	{{"打包的陨铁碎片"     	,{2,1,1049,1},msg},   	3.00*100},
--	{{"6级灵石包"          	,{2,1,30306,1},msg}, 	10.00*100},
--	{{"黄金大红包（空）"   	,{2,1,538,1},msg}, 	17.00*100,30},
--	{{"定魂陨铁神石"       	,{2,1,1067,1},msg},    3.00*100,30},
--	{{"大军功章"       		,{2,1,9998,1}},    	23.00*100 },
--	{{"辉煌军功章"       	,{2,1,9977,1},msg},    10.00*100 },
--	{{"凌波微步"       		,{0,112,78,1},msg},    1.00*100 },
--	{{"和氏璧"       		,{2,1,1001,1},msg},    2.50*100 },
--	
--	{{"3级千幻刻板"       		,{2,1,30408,1}},    	1.00*100 ,30},
--	{{"15级强化卷"       		,{2,1,30427,1},msg},    	0.50*100 ,30},
--	{{"14级强化卷"       		,{2,1,30426,1},msg},    	1.00*100 ,30},
--	{{"3级磨刀石"       		,{2,1,30430,1}},    	1.50*100 },
--}
--tClause3 = {
--	{{"磐龙璧"           	,{2,1,1000,1}},        15.00*100 },
--	{{"军功章"       		,{2,1,9999,1},msg},    6.00*100 },
--	{{"大人参果"           	,{2,0,553,1}},        	5.00*100 },
--	{{"高级师门秘籍包"      ,{2,1,30627,1}},        5.00*100 },
...
--	{{"打包的陨铁碎片"     	,{2,1,1049,1},msg},   	5.00*100 },
--	{{"斗魂"     			,{2,1,1157,1},msg},   	5.00*100 ,30},
--	{{"大军功章"       		,{2,1,9998,1}},      	5.00*100 },
...
--	--{{"洗髓灵丹"       		,{2,0,137,1},msg},	1.00*100 },
--	{{"种子包"       		,{2,1,30087,1}},	4.00*100 },
--	{{"大般若种子"       	,{2,0,398,1}},	5.00*100 },
--	{{"小般若种子"       	,{2,0,504,1}},	7.00*100 },
--	
--	{{"2级千幻刻板"       		,{2,1,30407,1}},    	1.00*100 ,30},
--	{{"14级强化卷"       		,{2,1,30426,1},msg},    0.25*100 ,30},
--	{{"13级强化卷"       		,{2,1,30425,1}},    	0.50*100 ,30},
--	{{"2级磨刀石"       		,{2,1,30429,1}},    	1.00*100 },
...
--}
--tClause4 = {
--	{{"小白驹丸"          	,{2,1,30307,1}},		5.00*100 },
--	{{"小三清丸"          	,{2,1,30308,1}},		5.00*100 },
--	{{"小六神丸"          	,{2,1,30309,1}},		5.00*100 },
--	{{"传功丹"         	 	,{2,1,30313,1}}, 		5.00*100 },
--	{{"高级师门秘籍包"      ,{2,1,30627,1}},        2.80*100 },
...
--}
--tClause5 = {
--	{{"武林早报"         	,{2,1,30314,1}},       20.00*100},
--	{{"师门圣物"         	,{2,1,30311,1}},      	20.00*100},
--	{{"小传功丹"          	,{2,1,30312,1}},      	18.00*100},
--	{{"修真要诀残页"        ,{2,1,30315,1}},      	10.00*100},
...
--
--	local szMsg = "花费2个"..TTJLInfo[4].."开启箱子";
--	local tSel = {
...
--		speLoot(nNpcIdx);
--	else
--		Talk(1, "", "你身上没有["..T_TIANJIAOLING[4].."]，不能开启<color=green>聚义宝箱<color>。["..TTJLInfo[4].."]可以通过<color=yellow>商城<color>获得");
--	end
--end
--
