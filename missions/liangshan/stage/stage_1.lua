...
tStage_1.tSkipNpc = {
	...
	tItem  = {TTJLInfo[4],TTJLInfo[1],TTJLInfo[2],TTJLInfo[3]},
...
function tStage_1:skip(bSure,nSubWorld)
	...
	if not bSure then
	local name = "<color=green>"..GetTargetNpcName().."<color>";
		Say(name..format(NpcSayInfo[6][4][1],self.tSkipNpc.nDelNum,TTJLInfo[4]),getn(NpcSayInfo[6][4][2]),NpcSayInfo[6][4][2])
		return
	end
