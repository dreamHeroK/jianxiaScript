...
thisFile = "\\script\\missions\\yp\\hls\\mission.lua";
...
tbHLS = gf_CopyInherit(missionHead, tbHLS)
firePhases = {
	timerID = 117,
	frequency = 18*2,
...
function hls_enter(m,nNewPosX,nNewPosY)
	SendScript2VM("\\script\\missions\\yp\\hls\\entrynpc.lua", "enter()")
