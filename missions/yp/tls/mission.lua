...
--	yp_CreateMonster(tNpcs[m].jy2,tPos[m].jy2);
	local tHwPos = {
		[5074] = {
			[1] = {{1592,3294},{1610,3327}},
			[2] = {{1644,3426},{1695,3400}},
		    [3] = {{1713,3432},{1693,3392}},
		},	
	};
...
tbDLTLS.msOption.bForbitTeam = 1; --可以组队
tbDLTLS.msOption.nInitFightState = nil; --战斗状态
tbDLTLS.msOption.nRestoreFightState = nil; --战斗状态
tbDLTLS.msOption.bRestoreTempEffect = 0; --是否清除临时状态
