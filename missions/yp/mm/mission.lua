...
tbXXMM.msOption.bForbitTeam = 1; --可以组队
tbXXMM.msOption.nInitFightState = nil; --战斗状态
tbXXMM.msOption.nRestoreFightState = nil; --战斗状态
tbXXMM.msOption.bRestoreTempEffect = 0; --是否清除临时状态
