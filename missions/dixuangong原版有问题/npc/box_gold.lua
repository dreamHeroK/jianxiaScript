...
_t_ib_award_no_stage1 =
{
	...
	{
		--{"紫霞秘籍",{0,107,65,1, 4}},
		{"Thi猲 Ki猽 L謓h",{2, 97, 236,2},_stat_when_ib_consume},
	...
	t_ib_award =--ib奖励
	{
        ...
        { {"Hu﹏ chng anh h飊g", {2,1,30499,1,4}, nil,nil, {1, 100}}, 563},
        ...
        { {"竜 Cho祅g Du Hi謕", {0,152,26,1}, nil,1, {1, 100}}, 30},
        { {"竜 Cho祅g Thi誸 Huy誸", {0,152,27,1}, nil,1, {1, 100}}, 30},
        { {"竜 Cho祅g V﹏ Du", {0,152,28,1}, nil,1, {1, 100}}, 30},
        { {"Ho祅g Kim Чi H錸g Bao (tr鑞g)", {2,1,538,1}, 15}, 750},
    		{ {"B筩h Kim Чi H錸g Bao (kh玭g)", {2,1,30228,1}, 15}, 100},
	},
}
