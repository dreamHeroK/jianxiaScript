...
_t_free_award_no_stage =
{
	...
	t_daibi_group =
	{
		...
		{ {"皓月碎片", {2,95,740,20}, nil,nil,{1, 100} }, 1000},
		{ {"皓月碎片", {2,95,740,20}, nil,nil,{1, 100} }, 1000},
		{ {"皓月碎片", {2,95,740,20}, nil,nil,{1, 100} }, 2000},
		{ {"皓月碎片", {2,95,740,20}, nil,nil,{1, 100} }, 2000},
		{ {"皓月碎片", {2,95,740,20}, nil,nil,{1, 100} }, 3000},
		{ {"皓月碎片", {2,95,740,20}, nil,nil,{1, 100} }, 2000},
		{ {"皓月碎片", {2,95,740,20}, nil,nil,{1, 100} }, 4000},
		{ {"天使镇魂玉", {2,103,153,1}, nil,nil,{1, 100} }, 2000},
...
_t_ib_award_no_stage =
{
	...
	t_ib_award =--ib奖励
	{
		{{"八宝粽子",{2,1,1125,1},nil,nil,{1, 100} },800},
		{{"地玄金令",{2,95,674,1},nil,msg,{1, 100}, {3142,16}},50},
		{{"玄阴玉",{2,95,1500,1},nil,msg,{1, 100}, {3142,16}},45},
		{{"耀阳碎片", {2,95,741,99},nil,nil, {1, 100}},1500},
		{{"九转回魂丹",{1,0,32,1},nil,nil,{1, 100} },800},
		{{"神器",{2,95,55,20},nil,nil,{1, 100} },2000},
		{{"皓月碎片", {2,95,740,250}, nil,nil,{1, 100} }, 1000},
		{{"陨铁精石",{2,1,1009,50},nil,nil,{1, 100} },2000},
		{{"五华聚元散",{1,0,261,1},nil,nil,{1, 100} },1000},
		{{"七华聚元散",{1,0,267,1},nil,nil,{1, 100} },1000},
		{{"五行天仪箱子",{2,103,152,1},nil,nil,{1, 100} }, 200},
		{{"天使装备箱",{2,103,153,1},nil,nil,{1, 100} }, 500},
		{{"披风箱子", {2,103,151,1},nil,nil,{1, 100} }, 200},
		{{"徽章箱子", {2,103,150,1},nil,nil,{1, 100} }, 200},
		{{"地玄金令", {2,95,674,1},nil,nil,{1, 100} }, 200},
		{{"皓月碎片", {2,95,740,150},nil,nil,{1, 100} }, 1000},
