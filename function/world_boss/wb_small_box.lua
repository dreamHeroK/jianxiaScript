...
function main()
	...
	if gf_GetTaskByte(TSK_GET_ITEM_TIME, TSK_GET_ITEM_COUNT_BYTE) >= 5 then
		Talk(1,"","每天最多只能捡5袋")
		return 0
	end
	...
	tAllAward[7]:giveClause();--给与随机奖励
	SendScript2VM("\\script\\misc\\huoyuedu\\huoyuedu.lua", format("AddHuoYueDu(%d)",9));
	end