...
--	local msg = format("世界boss%s已经出现在%s,请侠士们尽快前往以维护城市秩序！", WB_WORLD_BOSS[nIndex][2], WB_WORLD_BOSS_MAP[nIndex]);
--	local msg = format("世界boss%s已经出现在"..map_name..","..mapx..","..mapy..",请侠士们尽快前往以维护城市秩序！", WB_WORLD_BOSS[nIndex][2]);
    local msg = format("世界BOSS%s出现在"..map_name.."("..vt.."),请侠士们尽快前往！", WB_WORLD_BOSS[nIndex][2]);
	Msg2Global(msg);
	AddLocalNews(msg);		
...
function wb_KillAward()
    tAllAward[8]:giveClause();--给与随机奖励
end

function zcwb_KillAward()
