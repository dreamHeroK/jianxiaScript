...
function SelectGameStyle()
	local selTab = {};
	local szTitle = format("<color=green>擂台老板<color>：擂台是提供给各路英雄好汉比武切磋的地方，根据比赛类型的不同分为<color=yellow>单人对战擂台<color>、<color=yellow>组队对战<color>和<color=yellow>组队混战<color>三种，各位使土可以选择相应的比武类型进行比试: ")
