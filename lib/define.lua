...
------------------------------------------------------------
ITEM_DXG_TONGTIANLING = {2, 97, 236, "天骄令"};  
...
--==================资料片比武大会新加=====================
TASKID_BIWU_BLOCK_ROUTE		= 3227; --屏蔽的流派
...
TASKID_XOYO_GOLD = 2390; --逍遥币
TASKID_XOYO_CONSUME = 2391; --逍遥币的消耗
TASKID_XOYOYU_GOLD = 2392; --逍遥玉
TASKID_XOYOYU_CONSUME = 2393; --逍遥玉的消耗
...
--游侠值系统
TASKID_YOUXIA_WEEK = 2737; -- 记录本周游侠值
