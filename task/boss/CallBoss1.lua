...
function main()
	AddLocalNews("通缉：野外BOSS【上古神兽白虎】突然出现，泉州府北，请各位大侠火速出手，将其击杀，可获得其携带的宝物！！！！")
		local sjcs = 0
		local sjs = 0
		...
		if sjs <= 100 then
			sjcs = sjcs + 1
			npcIndex = CreateNpc("白虎王BOSS01","上古神兽白虎",108,1504,3025,-1,1,1,1)
			msg="江湖传闻，上古神兽白虎突然出现在[泉州府北]江湖上又将引起一阵血雨腥风！"
			Msg2SubWorld(msg);
