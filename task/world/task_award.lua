...
--head 对应 帽子
--trinket 对应 饰品
--里面填写的内容是base的数字，为标准男，其他的体形前两位数字相同
--最后一位+18
--比如标准男是 0 100 3，魁梧男就是0 100 21，性感女为 0 100 39，娇小女为 0 100 57
--饰品除外
...
function GivePlayerWeapon(ItemLevel,Attribute,nType)
    ...
    elseif nRoute == 2 and Attribute == nil and nType == nil then
    	...
    	Say("请选择您想要的奖励类型",
    		2,
    		"棍类武器/#GivePlayerWeapon("..ItemLevel..",999,3)",
    		"刀类武器/#GivePlayerWeapon("..ItemLevel..",999,5)")
    	return
    elseif nRoute == 2 and Attribute ~= nil and nType == nil then
    	ItemLevel = Weapon_Level[ItemLevel][1];
    	Say("请选择您想要的奖励类型",
    		2,
    		"棍类武器/#GivePlayerWeapon("..ItemLevel..","..Attribute..",3)",
    		"刀类武器/#GivePlayerWeapon("..ItemLevel..","..Attribute..",5)")
    	return
...
local k = SpecialItemData[nType][3];
	...
	Msg2Player("获得"..nNum..SpecialItemData[nType][4]);
...
function GivePlayerExp(sMainTask,sDetailTask)
	...
	if nExpNum==nil or nExpNum == 0 then
		...
		ModifyExp(nExpNum);
		Msg2Player("恭喜侠士获得了"..nExpNum.."点经验!");		
	end
end