...
function SelectSay()	
	local tbSayDialog = {};
	local nSaySize = 0;
	local szSayHead = "Th«ng tin chi tiÕt c¸c ho¹t ®éng ®ång ®¹o cã thÓ xem t¹i trang chñ <color=green>https://volam2.zing.vn<color>."
	...
	tinsert(tbSayDialog, format("Sù kiÖn %s/monthlyEvent_OnNpcTalk", g_monthlyEvent_Name))
	----------------------------------
...
--     		szSayHead = "Ho¹t ®éng th¸ng 3 diÔn ra trong thêi gian tõ ngµy 25 th¸ng 2 n¨m 2011 ®Õn 24 giê ngµy 27 th¸ng 3 n¨m 2011, néi dung chi tiÕt t¹i trang chñ <color=red>https://volam2.zing.vn<color>"
...
function NextPage2()
	...
	local nDate = tonumber(date("%Y%m%d"))
      ...
      if nDate >= 20101210 and nDate <= 20110109 then
    		szSayHead = "<color=yellow>Ho¹t ®éng mõng Gi¸ng Sinh<color> b¾t ®Çu tõ <color=red>ngµy 10/12/2010 ®Õn ngµy 09/1/2011<color>. Néi dung chi tiÕt vui lßng t×m hiÓu t¹i trang chñ <color=green>https://volam2.zing.vn<color>"
   	 end
