...
function main()
	local selTab = {
				"地图区域介绍/jieshao",
				"离开抽丝和制皮地图/leave",
				"我要去紫桑山(高级)/#NewWorld(722,1748,3420)",
...
function jieshao()
	Say("空桑山主要是抽丝和制皮的低级区域, 左上角产出的是<color=yellow>兔毛和狼皮<color>, 右上角产出的是<color=yellow>蚕丝和虎皮<color>. 左下角产出的是<color=yellow>五色丝和蛇皮<color>, 右下角产出的是<color=yellow>狼蛛丝和狐皮<color>.",0)
end;
