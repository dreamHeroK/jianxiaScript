...
function jieshao()
    Say("苍龙岭是主要的砍伐高级树木的林区和集灵的区域,  顶部主要产出的是<color=yellow>铁线木<color>, 集灵是<color=yellow>70级<color>. 左下角产出的是<color=yellow>波罗木<color>, 集灵是<color=yellow>80级<color>. 右下角产出的是<color=yellow>檀木<color>, 集灵是<color=yellow>90级<color>.",0)
end;
function no()
end;
