...
TASKID_TMZ_GET_RANK_BIT_FLAG = 126;	 --记录玩家是否领取附加奖励
TASKID_TMZ_GET_RANK_NUM = 127;	 --记录玩家领取排名奖励次数
TASKID_TMZ_GET_RANK_FLAG = 128;	 --记录玩家领取排名奖励标识
TASKID_TMZ_GET_HUFU_NUM = 129;	 --记录玩家每日虎符领奖次数
...
GL_IP_DAILY_ONLINE_TIME = 1202 		-- 记录每日在线时间统计
-->
...
VET_TSK_IPBONUS_ONLINE_pk = 2671            --pk模式登录提示
VET_TSK_IPBONUS_ONLINE_zxianfenghao = 2673  --封号  1为封号，0为解封
VET_TSK_LIANGSHAN_DAILY = 2674              --梁山每日通关次数
VET_TSK_DIXUANGONG_DAILY = 2675              --地玄宫每日通关次数
VET_TSK_TAIYI_DAILY = 2676                   --太一宫每日通关次数
VET_TSK_TONGTIAN_DAILY = 2677                   --通天宫每日通关次数
VET_TSK_DIANKAJIFE_DAILY = 2678                 --点卡统计
VET_TSK_EMPLACEMENT_BATTLE_DAILY = 2679          --每日炮台补领次数
VET_TSK_MAIN_BATTLE_DAILY = 2680                 --每日主战场补领次数
--梁山相关:村长-2011-3-7增加
