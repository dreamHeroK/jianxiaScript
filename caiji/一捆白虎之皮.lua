...
szItemParticular = 	{46,22}			-- 采集物品的详细类别
...
nSkillID = 2						-- 制皮技能ID
nSkillLevelLow = 41					-- 需要达到的采集技能最低等级
nSkillLevelHigh = 50				-- 需要达到的采集技能最高等级
...
function OnProgressCallback()
	...
	-- 提示
	if (nChoice == 1) then
		Say("你已经采集了"..nSelCount.."捆白虎之皮！", 0)
	elseif (nChoice == 2) then
		Say("您的运气不错，包裹里有"..nSelCount.."个织锦！", 0)
	else
