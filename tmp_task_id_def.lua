...
TMP_TASK_GM_TAG = _TMP_TASK_ID_VEIT_BEGIN + 20; --GM宝典相关标识（20-29占用）
TMP_TASK_TAIXU = _TMP_TASK_ID_VEIT_BEGIN + 30; --太虚（30-43占用）
...
TMP_TASK_XIAKE = _TMP_TASK_ID_VEIT_BEGIN + 50; --侠客租赁（50-56占用）
