...
function main()
	...
	--提示
	Msg2Player("你进了"..Tb_5_element_coordinate[golden_element_seq][3].."行阵,可以抗"..Tb_5_element_coordinate[Tb_5_element_coordinate[golden_element_seq][1]][3].."让五行轮回生和"..Tb_5_element_coordinate[Tb_5_element_coordinate[golden_element_seq][2]][3].."使五行轮回刻骨铭心!")
end
